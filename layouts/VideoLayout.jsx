...
const VideoLayout = ({
  ...
  return (
    <div className="flex flex-col gap-3 justify-center items-start sm:m-0 xs:max-w-[370px]">
      <Link to={`/watch/${videoId}`}>
        <div className="relative">
          <img
            src={thumbnail}
            alt={title}
            className="w-full rounded-[10px] hover:rounded-none aspect-video object-cover duration-300"
          />
          <p
